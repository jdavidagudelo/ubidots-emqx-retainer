...
t_retain_handling(_) ->
    ...
    Env =
        ubidots_emqx_retainer_payload_changer:get_test_env(),
    ReactorRedisClient =
        ubidots_emqx_retainer_payload_changer:get_reactor_redis_client(Env),
    UbidotsRedisClient =
        ubidots_emqx_retainer_payload_changer:get_ubidots_redis_client(Env),
    ubidots_emqx_retainer_payload_changer:initialize_mqtt_cache(ReactorRedisClient,
                                                                UbidotsRedisClient,
                                                                "token",
                                                                "owner_id",
                                                                Devices),
