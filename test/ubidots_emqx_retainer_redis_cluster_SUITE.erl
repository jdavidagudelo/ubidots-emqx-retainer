...
%%%-------------------------------------------------------------------
-module(ubidots_emqx_retainer_redis_cluster_SUITE).
...
init_per_testcase(_TestCase, Config) ->
    ...
    application:set_env(?APP, reactor_cache_type, cluster),
...
t_retain_cluster_value(_) ->
    ...
    Env = ubidots_emqx_retainer_test_utils:get_redis_cluster_test_env(),
    ubidots_emqx_retainer_test_utils:init_redis_cluster_ubidots(pool_core, Env),
    ubidots_emqx_retainer_test_utils:init_redis_cluster_reactor(pool_reactor, Env),
    ubidots_emqx_retainer_test_utils:initialize_mqtt_cache(pool_reactor,
                                                           cluster,
                                                           pool_core,
                                                           cluster,
                                                           "token",
    ...
    ubidots_emqx_retainer_test_utils:flushdb(pool_reactor, cluster, pool_core, cluster),
